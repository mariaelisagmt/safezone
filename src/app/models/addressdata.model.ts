export class AddressData {
  ...
  getAddress(): string {
    ...
    switch (this.addresstype) {
      ...
      case 'amenity': {
        // Exemplo: restaurante, escola, hospital. Alguns desses podem ter numeração ou o campo "amenity" na API
        const roadAddress = this.address.house_number
          ? `${this.address.road} ${this.address.house_number}`
          : this.address.road;
